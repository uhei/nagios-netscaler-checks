...
if __name__ == "__main__":
	parser = argparse.ArgumentParser(description='Check Netscaler disk usage (in percent)')
	...
	try:
		nitro_session.login()
				...
				if  args.warning and args.critical:
					if ( float(obj[i].disk0perusage) >= float(args.critical) ) or ( float(obj[i].disk1perusage) >= float(args.critical) ):
						print("CRITICAL: /flash " + str(obj[i].disk0perusage) + "%, /var " + str(obj[i].disk1perusage) + "% | 'flash'=" + str(obj[i].disk0perusage) + "%;" + args.warning + ";" + args.critical + ";; 'var'=" + str(obj[i].disk1perusage) + "%;" + args.warning + ";" + args.critical + ";;")
						nitro_session.logout()
						sys.exit(2)
					elif ( float(obj[i].disk0perusage) >= float(args.warning) ) or ( float(obj[i].disk1perusage) >= float(args.warning) ):
						print("WARNING: /flash " + str(obj[i].disk0perusage) + "%, /var " + str(obj[i].disk1perusage) + "% | 'flash'=" + str(obj[i].disk0perusage) + "%;" + args.warning + ";" + args.critical + ";; 'var'=" + str(obj[i].disk1perusage) + "%;" + args.warning + ";" + args.critical + ";;")
						nitro_session.logout()
						sys.exit(1)
					else:
						print("OK: /flash " + str(obj[i].disk0perusage) + "%, /var " + str(obj[i].disk1perusage) + "% | 'flash'=" + str(obj[i].disk0perusage) + "%;" + args.warning + ";" + args.critical + ";; 'var'=" + str(obj[i].disk1perusage) + "%;" + args.warning + ";" + args.critical + ";;")
						nitro_session.logout()
						sys.exit(0)
				else:
					print("OK: /flash " + str(obj[i].disk0perusage) + "%, /var " + str(obj[i].disk1perusage) + "% | 'flash'=" + str(obj[i].disk0perusage) + "%;;;; 'var'=" + str(obj[i].disk1perusage) + "%;;;;")
					nitro_session.logout()
					sys.exit(0)
